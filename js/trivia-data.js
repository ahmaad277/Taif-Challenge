...
const TRIVIA_QUESTIONS = [
  ...
  { categoryId: 'science', question: 'ما الغاز الذي تخرجه النباتات ليلاً؟', options: ['الأكسجين', 'ثاني أكسيد الكربون', 'غاز الأرгон', 'الهيليوم'], correctIndex: 1 },
  ...
  { categoryId: 'historyGeo', question: 'ما عاصمة أستراليا؟', options: ['سيدني', 'ملبورن', 'كانberra', 'بيرث'], correctIndex: 2 },
  { categoryId: 'puzzles', question: 'كم مجموع زوايا المثلث؟', options: ['90', '180', '270', '360'], correctIndex: 1 },
  { categoryId: 'science', question: 'ما المعدن السائل في درجة حرارة الغرفة؟', options: ['الزنك', 'الزئbق', 'الرصاص', 'القصدير'], correctIndex: 1 },
  { categoryId: 'historyGeo', question: 'ما عاصمة كندا؟', options: ['تورonto', 'فancouver', 'أوتawa', 'مontreal'], correctIndex: 2 },
  ...
  { categoryId: 'science', question: 'ما هو المكون الأساسي للؤلؤ الطبيعي؟', options: ['كربونات الكالسيوم', 'السيليكا', 'الكوartz', 'الصوديوم'], correctIndex: 0 },
